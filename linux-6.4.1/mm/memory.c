...
int (*nf_pafault_lock)(void);
int (*nf_pafault_unlock)(void);
EXPORT_SYMBOL(nf_pafault_lock);
EXPORT_SYMBOL(nf_pafault_unlock);
	...
	unsigned int flags, struct pt_regs* regs)
{
	...
	if (is_nf_test && is_nf_test() && nf_pafault_unlock)
		nf_pafault_unlock();
...
out:
	...
	if (is_nf_test && is_nf_test() && nf_pafault_lock)
		nf_pafault_lock();
