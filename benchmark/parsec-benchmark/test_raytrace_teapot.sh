...
echo -n > result/raytrace/teapot_new.txt
...
echo -n > result/raytrace/teapot_old.txt
...
echo -n > result/raytrace/teapot_tcs.txt
...
echo -n > result/raytrace/teapot_tcb.txt
...
echo "test result:"
echo -n "BCD:       "
python3 get_time_1.py result/raytrace/teapot_new.txt
echo -n "baseline:  "
python3 get_time_1.py result/raytrace/teapot_old.txt
echo -n "TCLock SP: "
python3 get_time_1.py result/raytrace/teapot_tcs.txt
echo -n "TCLock B:  "
python3 get_time_1.py result/raytrace/teapot_tcb.txt