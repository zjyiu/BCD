...
ops_new = load_numbers("./mutex/cache/array/new.txt")
ops_old = load_numbers("./mutex/cache/array/old.txt")
ops_tcs= load_numbers("./mutex/cache/array/tcs.txt") 
ops_tcb= load_numbers("./mutex/cache/array/tcb.txt") 
...
plt.savefig('mutex/cache/array/result.pdf', format='pdf')
plt.show()
