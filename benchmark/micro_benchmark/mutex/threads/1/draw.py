...
ops_new = load_numbers("./mutex/threads/1/new.txt")
ops_old = load_numbers("./mutex/threads/1/old.txt")
ops_tcs= load_numbers("./mutex/threads/1/tcs.txt") 
ops_tcb= load_numbers("./mutex/threads/1/tcb.txt") 
...
plt.savefig('mutex/threads/1/result.pdf', format='pdf')
plt.show()
