...
ops_new = load_numbers("./mutex/threads/4/new.txt")
ops_old = load_numbers("./mutex/threads/4/old.txt")
ops_tcs= load_numbers("./mutex/threads/4/tcs.txt") 
ops_tcb= load_numbers("./mutex/threads/4/tcb.txt") 
...
plt.savefig('mutex/threads/4/result.pdf', format='pdf')
plt.show()
